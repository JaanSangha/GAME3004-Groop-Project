...
/**
* Author: NICHOLAS FALSITTA (Game Engines IV, GAME PORTFOLIO DEVELOPMENT)
* Singleton Class made by Nicholas Falsitta (George Brown College)
* 
**/
		...
		get {
			...
			if (_instance == null) {
				...
				if (_instance == null) {
					...
					Debug.Log("CREATING NEW " + _instance.gameObject.name);
				}
			}	
			return _instance;
		}
